...
VALUES
  ...
  ('demo_bogazici_location_profile_requester_ucaksavar', 'demo_bogazici_profile_requester_ucaksavar', 'Ucaksavar Kampusu yolu', 'Ucaksavar area above Hisarustu, Besiktas, Istanbul', 'Istanbul', 'Turkiye', 'TR', 'Besiktas', 'Etiler', 'Ucaksavar campus access road', 41.09600, 29.02800, 30, 'DEMO_DEVICE_GPS', CURRENT_TIMESTAMP - INTERVAL '16 minutes'),
...
VALUES
  ...
  ('demo_bogazici_location_ucaksavar_support', 'demo_bogazici_request_ucaksavar_support', 'Turkiye', 'Istanbul', 'Besiktas', 'Etiler', 'Ucaksavar campus access road', 41.09600, 29.02800, TRUE, FALSE, CURRENT_TIMESTAMP - INTERVAL '16 minutes')
