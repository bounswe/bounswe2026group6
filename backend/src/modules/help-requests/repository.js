...
function mapHelpRequest(row) {
  ...
  return {
    ...
    shareProfileHealthInfoWithVolunteer: row.share_profile_health_info_with_volunteer || false,
  ...
  try {
    ...
    const requestResult = await client.query(
      ...
      [
        ...
        input.shareProfileHealthInfoWithVolunteer || false,
        input.contact.fullName || null,
        input.contact.phone,
    ...
    if (input.location) {
      ...
      const locationResult = await client.query(
        ...
        [
          ...
          input.location.neighborhood || null,
    ...
    const requestResult = await client.query(
      `
        ...
        SET help_types = $2,
            ...
            description = $8,
            blood_type = NULL,
            share_profile_health_info_with_volunteer = $9,
