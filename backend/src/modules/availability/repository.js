...
const SEARCH_AND_RESCUE_HELP_TYPES = new Set(['search_rescue', 'search_and_rescue', 'sar', 'fire_brigade', 'rescue']);
const SUPPLIES_HELP_TYPES = new Set(['food_water', 'food', 'water', 'basic_supplies', 'supplies']);
